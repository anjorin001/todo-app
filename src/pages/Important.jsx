    ...
    <div className="main-content">
      <main className="task-content">
              ...
              <li key={i} className="task-line">
                {tasks[page][i] ? (
                  <div
                    ...
                    onContextMenu={(e) =>
                      handleContextMenu(e, tasks[page][i].id)
                    }
                  >
                    <div className="task-value">
                      <div
                        onClick={(e) =>
                          handleIdPass(e, tasks[page][i].id, "check")
                        }
                      >
                        <Checkbox />
                      </div>
                    ...
                    <div className="task-time">
                      <p>
                        {tasks[page][i].time}{" "}
                        {tasks[page][i].time && tasks[page][i].date ? "•" : ""}{" "}
                        {tasks[page][i].date}
                      </p>
                    </div>
                  </div>
        ...
        {menu.visible && (
          ...
          >
            <div onClick={(e) => handleIdPass(e, menu.todoId, "edit")}>
              Edit
            </div>
            <p className="separator"></p>
            <div onClick={(e) => handleIdPass(e, menu.todoId, "delete")}>
              Delete
            </div>
          </div>
        )}
